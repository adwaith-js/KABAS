    ...
    return (
      <div className="min-h-screen">
        <div className="max-w-[1600px] mx-auto p-8 relative z-10">
          ...
          <div className="p-6 glass-card border-red-200/50 text-red-700 mt-4">
      ...
      <div className="max-w-[1600px] mx-auto p-4 sm:p-8 relative z-10">
        ...
        <div className="mb-6 sm:mb-8">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div className="flex items-center gap-3 flex-wrap">
              <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">{teamName}</h1>
            ...
            <div className="flex items-center gap-2 flex-wrap">
              ...
              <Button
                className="bg-[#2C5F8D] hover:bg-[#234a6f] gap-2 w-full sm:w-auto"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-8">
          ...
          >
            ...
            <div className="text-center mt-2 px-2 pb-2">
              <div className="text-3xl font-bold text-gray-900">{analysis.totalTasks}</div>
              <div className="text-xs text-gray-500 uppercase tracking-wide font-semibold mt-1">Total Tasks</div>
            </div>
          </MetricCard>
                    ...
                    <tr key={member.id} className="hover:bg-white/40 transition-colors">
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-3">
                          <div className="h-8 w-8 rounded-full bg-gradient-to-br from-blue-600 to-blue-400 text-white flex items-center justify-center text-sm font-semibold shadow-sm">
              ...
              return (
                <div key={member.id}>
                  <button
                    ...
                    className="w-full flex items-center justify-between p-4 bg-white/50 hover:bg-white/80 rounded-xl transition-all border border-transparent hover:border-gray-200/50"
                  >
                    <div className="flex items-center gap-3">
                      <div className="h-8 w-8 rounded-full bg-gradient-to-br from-blue-600 to-blue-400 shadow-sm text-white flex items-center justify-center text-sm font-semibold">
                        {member.name.charAt(0).toUpperCase()}
                      </div>
